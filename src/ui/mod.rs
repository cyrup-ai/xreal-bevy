        ...
        if settings_panel.is_open {
            egui::Window::new("XREAL Settings")
                ...
                ui.horizontal(|ui| {
                    ...
                    ui.selectable_value(&mut top_menu.selected_tab, AppTab::Screen, "🖥️ Screen");
                ...
                match top_menu.selected_tab {
                    AppTab::Settings => {
                        ...
                        ui.group(|ui| {
                            ...
                            if ui.button("Recenter").clicked() {
                                if let Err(e) = command_sender.0.send(Command::Recenter) {
                    ...
                    AppTab::Screen => {
                        ...
                        ui.group(|ui| {
                            ...
                            ui.add(
                                egui::Slider::new(&mut screen_distance.0, 0.5..=5.0).suffix("m"),
                            );
                        });
