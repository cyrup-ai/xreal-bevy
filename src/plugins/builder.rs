...
impl<NAME, CAPS> PluginBuilder<state::HasId, NAME, CAPS, state::Incomplete> {
    ...
    ) -> PluginBuilder<state::HasId, state::HasName, CAPS, state::Incomplete> {
...
impl<NAME, CAPS> PluginBuilder<state::NoId, NAME, CAPS, state::Incomplete> {
    ...
    pub fn id(
        mut self,
        id: impl Into<String>,
    ) -> PluginBuilder<state::HasId, NAME, CAPS, state::Incomplete> {
...
impl<ID, NAME> PluginBuilder<ID, NAME, state::NoCapabilities, state::Incomplete> {
    ...
    /// ```
    pub fn supports_transparency(
        self,
    ) -> PluginBuilder<ID, NAME, state::HasCapabilities, state::Incomplete> {
    ...
    /// ```
    pub fn supports_compute_shaders(
        self,
    ) -> PluginBuilder<ID, NAME, state::HasCapabilities, state::Incomplete> {
        let mut caps = PluginCapabilities::default();
...
impl<ID, NAME> PluginBuilder<ID, NAME, state::HasCapabilities, state::Incomplete> {
    ...
    pub fn capabilities(self) -> PluginCapabilities {
        self.capabilities
            .expect("Capabilities should be set in HasCapabilities state")
    }
}
...
impl SimplePluginBuilder {
    ...
    pub fn build(self) -> PluginMetadata {
        ...
        PluginMetadata {
            id: super::fast_data::create_plugin_id(
                &self.id.unwrap_or_else(|| "unknown.plugin".to_string()),
            ),
            name: super::fast_data::create_plugin_name(
                &self.name.unwrap_or_else(|| "Unknown Plugin".to_string()),
            ),
            ...
            minimum_engine_version: super::fast_data::create_plugin_version(
...
impl PluginBuilder<state::HasId, state::HasName, state::HasCapabilities, state::Incomplete> {
    ...
    pub fn build(self) -> PluginMetadata {
        ...
        PluginMetadata {
            id: super::fast_data::create_plugin_id(
                &self.id.expect("ID should be set in HasId state"),
            ),
            name: super::fast_data::create_plugin_name(
                &self.name.expect("Name should be set in HasName state"),
            ),
            version: super::fast_data::create_plugin_version(&self.version),
            description: super::fast_data::create_plugin_description(&self.description),
            author: super::fast_data::create_plugin_author(&self.author),
